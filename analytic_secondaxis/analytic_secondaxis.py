...
class project_activity_al(models.Model):
    ...
    def _get_first_AA_wich_have_activity(self, account):
        ...
        if account.activity_ids:
            ...
            if account.parent_id:
                return self._get_first_AA_wich_have_activity(
                    account.parent_id)
            else:
                return False
    ...
    def name_search(self, name, args=None,
        ...
        return self.name_get(account)

    def _compute_level_tree(self, ids, child_ids, res, field_names,
                            context=None):
